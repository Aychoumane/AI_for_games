...
void genmove() {
  ...
  //Génération d'un mouvement et l'applique 
...
// Fonction qui applique un mouvement, prend une position de départ a et b , et une position final c et d 
// De la forme ordonnée et abcisse : Nombre suivi de lettre ex 8b -> 9a 
