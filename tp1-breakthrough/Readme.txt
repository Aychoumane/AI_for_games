...
q1- Définir :
+ une fonction heuristique pour la variante classique , prendre le contenu de random_player et faire un new fichier heuristique_player
...
q2b- Ajouter la variante à captures forcées (dans mybt.h et dans run_many_games.pike) X 
